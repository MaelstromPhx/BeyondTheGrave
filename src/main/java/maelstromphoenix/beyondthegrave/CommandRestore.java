...
public class CommandRestore extends SubCommand{
	...
	public String getDescription() {
		return "Restores the <player>'s inventory at given <index> to <targetplayer>'s inventory. 0 is the most recent. Holds up to " + InventoryBackup.MAXINVENTORYBACKUPS + " backups.";
	}
